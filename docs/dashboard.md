...
Send Test Packet allocates/persists a real sequence and performs a real Protocol 2 exchange. Any command in its ACK is processed with the same durable/idempotent semantics as a normal poll.
